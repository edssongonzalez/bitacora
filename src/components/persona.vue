        ...
        <template>
          ...
          >
            <template v-slot:item.actions="{ item }">
              ...
              <v-icon class="mr-2" @click="estado(item.idpersona,item.estado)" color="orange darken-3">fa-shuffle</v-icon>
            </template>
              ...
              <v-container>
                <v-form v-model="valid" ref="form" lazy-validation @keyup.native.enter="ingresar()">
                  <v-row align="center" justify="center">
                    ...
                    <v-col cols="12" class="pa-0">
                      <v-text-field dense outlined v-model="Direccion" label="Direccion de la Persona" type="text" :rules="minRules" required>></v-text-field>
                    </v-col>
                    <v-col cols="12" class="pa-0">
                      <v-text-field dense outlined v-model="Correo" label="Correo de la Persona" type="text" :rules="minRules" required>></v-text-field>
                    </v-col>
                    <v-col cols="12" class="pa-0">
                      <v-text-field dense outlined v-model="CUI" label="CUI de la Persona" type="text" :rules="minRules" required>></v-text-field>
                    </v-col>
                  </v-row>
                </v-form>
              </v-container>
